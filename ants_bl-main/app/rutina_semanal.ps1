...
try {
    ...
    $scripts = @(
        "python .\app\rutina.py --semanal --naviera HAPAG-LLOYD",
        "python .\app\rutina.py --semanal --naviera CMA-CGM PIL",
        "python .\app\rutina.py --semanal --naviera ONE COSCO EVERGREEN WANHAI",
        "python .\app\rutina.py --semanal --naviera MSC ZIM YANGMING",
        "python .\app\rutina.py --semanal --naviera MAERSK HMM"
    )
